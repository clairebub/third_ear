...
public class SpeechApiService extends Service {
    ...
    private static final String PREF_FILE_KEY = SpeechApiService.class.getName() + ".SpeechService";
    ...
    public void onCreate() {
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                new KeepAliveApiConnectionTask().execute();
            }
        });
    }
    ...
    public void startRecognizing(int sampleRate) {
        Log.w(TAG, "start recognizing, mApi=" + mApi);
        if (mApi == null) {
    ...
    // A task that's responsible to keep the Api connection live
    // It reschedules itself to make sure the access token never expires
    private class KeepAliveApiConnectionTask extends AsyncTask<Void, Void, AccessToken> {
        @Override
        ...
        protected void onPostExecute(AccessToken accessToken) {
            if (accessToken == null) {
                Log.e(TAG, "Received null accessToken onPostExecute.");
                return;
            }
    ...
    //
    // This should really be provided as part of client library
    //
